...
<section id="<?php echo $section_id; ?>" class="home-section-<?php echo ($i+1); ?> <?php echo $section_css_class;?>">
       ...
       <h1 class="section-title <?php echo $section_title_class; ?>"><?php echo $section_title; ?></h1>
        ...
        <div class="section-subtitle"><?php echo do_shortcode($section_subtitle);?></div>
         ...
         <?php echo do_shortcode(wp_kses_post(onetone_option('partnership_editor'), $allowedposttags) );?>
...
//		 $animationtype = array('fadeInLeft','fadeInLeft','fadeInLeft','fadeInLeft','fadeInRight','fadeInRight','fadeInRight','fadeInRight');;//array('fadeInLeft','fadeInDown','fadeInRight','fadeInLeft','fadeInUp','fadeInRight','fadeInDown','fadeInDown');
//		 if( $link == "" )
