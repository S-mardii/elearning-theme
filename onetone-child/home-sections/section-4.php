...
<section id="<?php echo $section_id; ?>" class="home-section-<?php echo ($i+1); ?> <?php echo $section_css_class;?>">
       ...
       <h1 class="section-title <?php echo $section_title_class; ?>"><?php echo $section_title; ?></h1>
        ...
        <div class="section-subtitle"><?php echo do_shortcode($section_subtitle);?></div>
         ...
         <div class="row">
         <div class="col-md-8"><div class="magee-animated" data-animationduration="0.9" data-animationtype="fadeInLeft" data-imageanimation="no"><?php echo do_shortcode($left_content);?>
                 <br/> <br/> <center> <a href="./about-us" style="color:#eda869;border:1px solid #eda869; border-radius:2px; padding:5px 10px;">READ MORE</a><center>
