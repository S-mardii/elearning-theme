...
//        $section_menu        = array("Home","","Services","About","Courseware","Team","Gallery","Feedback","","Contact");
//	$section_slug        = array('home','','services','about','course','team','gallery','feedback','','contact');
//	$section_padding     = array('','30px 0','50px 0','50px 0','50px 0','50px 0','10px 0 50px','50px 0','50px 0');
//	$text_align          = array('center','left','center','center','center','left','center','left','center');
//	
	if( $options_saved )
