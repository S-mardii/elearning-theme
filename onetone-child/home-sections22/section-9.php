...
<section id="<?php echo $section_id; ?>" class="home-section-<?php echo ($i+1); ?> <?php echo $section_css_class;?>">
       ...
       <div class="section-subtitle"><?php echo do_shortcode($section_subtitle).'  Want to give your feedback?';?><a href="https://docs.google.com/forms/d/12tHGRAkwbMrqOP5uQlF2GkgjZHzTWJQyUJgAeW08TpE/viewform" target="_blank" class="btn-normal btn-lg">Click Here</a></div>
       <!--
       <div class="promo-action"><a href="#" target="_blank" class="btn-normal btn-lg">Here</a></div>
         -->
         <?php endif;?>
