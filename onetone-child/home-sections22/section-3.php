...
<section id="<?php echo $section_id; ?>" class="home-section-<?php echo ($i+1); ?> <?php echo $section_css_class;?>">
       ...
       <h1 class="section-title <?php echo $section_title_class; ?>"><?php echo $section_title; ?></h1>
        ...
        <div class="section-subtitle"><?php echo do_shortcode($section_subtitle);?></div>
         <?php endif;?>
       <div class="magee-animated" data-animationduration="0.9" data-animationtype="fadeDown" data-imageanimation="no" id="">

        <div style="color:<?php echo $color; ?>;">
 
<!--          <div class="magee-promo-box">
              <div class="promo-info">-->
                <?php echo do_shortcode('[frontpage_news widget="143" name="LastestPost"]');?>
<!--              </div>
              <div class="promo-action"><a href="<?php echo esc_url($btn_link);?>" target="<?php echo esc_attr($btn_target);?>" class="btn-normal btn-lg"><?php echo do_shortcode($btn_text);?></a></div>
