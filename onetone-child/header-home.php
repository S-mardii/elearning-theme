...
<head>
	...
	<meta name="google-site-verification" content="8XPIRzCq2ez4roKAJKcL4I1V9q76UuRjXYjvuJPf_-c" />
...
//							 }
                                                             ...
                                                             //edited 2016-04-28 by leng
//                                                           $myMenu = array("Home","","Services","About","Courseware","Team","Gallery","Feedback","FAQ","Contact","");
////                                                           $mySlug = array('home','','services','about','courses','team','gallery','feedback','','contact','');
//                                                           $myMenu = array("Home","","About","Services","Team","Courseware","Gallery","Feedback","FAQ");
//                                                           $mySlug = array('home','','about','services','team','courses','gallery','feedback','faq');
//                                                           for( $i = 0; $i <=8 ;$i++){
//                                                               $onepage_menu .= '<li  class="onetone-menuitem"><a id="onetone-'.$mySlug[$i].'" href="#'.$mySlug[$i].'" >
//                                                            <span>'.$myMenu[$i].'</span></a></li>';
//                                                           }
//                                                            
                                                             //End edited menu on header
							endif;
