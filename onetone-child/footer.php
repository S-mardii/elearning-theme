        ...
        <?php if( $enable_footer_widget_area == '1' ):?>
			...
			<div class="footer-info-area">
				<div class="container">	
					<div class="site-info">
					  <?php
                      if( is_home() || is_front_page()){ //edited 2016 @Leng
                        //printf(__('Copy right @ 2016 e-Learning center of ITC <a href="%s">MageeWP Themes</a>.','onetone'),esc_url('#'));
                          printf(__('Copy right @ 2016 e-Learning center of ITC ','onetone'));
                      }else{
						 printf(__('Copy right @ 2016 e-Learning center of ITC ','onetone')); 
						  }
                      ?>
