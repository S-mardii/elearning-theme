...
//							   15 => sprintf(__('Section %s', 'onetone'),15),
                                                           ...
                                                           1 => __('Section 1 - Banner', 'onetone' ),
							   2 => __('Section 2 - Slogan', 'onetone' ),
							   3 => __('Section 3 - About', 'onetone' ),
							   4 => __('Section 4 - Service', 'onetone' ),
							   5 => __('Section 5 - Courseware', 'onetone' ),
							   6 => __('Section 6 - Team', 'onetone' ),
							   7 => __('Section 4 - Gallery', 'onetone' ),
							   8 => __('Section 8 - Custom', 'onetone' ),
							   9 => __('Section 9 - Feedback', 'onetone' ),
							   10 => __('Section 10 - Contact', 'onetone' ),
							   11 => sprintf(__('Section %s', 'onetone'),11),
							   12 => sprintf(__('Section %s', 'onetone'),12),
							   13 => sprintf(__('Section %s', 'onetone'),13),
							   14 => sprintf(__('Section %s', 'onetone'),14),
							   15 => sprintf(__('Section %s', 'onetone'),15),
							   16 => sprintf(__('Section %s', 'onetone'),16),
							   );
	 ...
	 /*  $options[] = array(
	   ...
	   $options[] =   	 array(
		...
		switch( $i ){
			...
			break;
                        //Edited 4/26/2016 case number
			//Section About
			case "2": // Section About
  ...
  <div>
    ...
    <ul class="magee-icon-list">
      <li><i class="fa fa-internet-explorer">&nbsp;</i> <a href="#">Mageewp.com</a></li>
			...
			break;
			//Section Custom
                        case "7": // Section Custom
			
			
			
			break;
			//Section Testimonial
                        case "8": // Section Testimonial
