...
SHINES ONE PAGE SMALL BUSINESS WEBSITE.",
	...
	$section_content_typography_defaults = array(
	 ...
	 $home_sections = array(
							   ...
							   2 => __('Section 2 - Latest News', 'onetone' ),
							   3 => __('Section 3 - Service', 'onetone' ),
							   4 => __('Section 4 - Gallery', 'onetone' ),
							   5 => __('Section 5 - Team', 'onetone' ),
							   6 => __('Section 6 - About', 'onetone' ),
							   7 => __('Section 4 - Feedback Title', 'onetone' ),
							   8 => __('Section 8 - Feedback', 'onetone' ),
							   9 => __('Section 9 - Contact', 'onetone' ),
							   10 => sprintf(__('Courseware', 'onetone'),10),
							   11 => sprintf(__('FAQ', 'onetone'),11),
							   12 => sprintf(__('Partnership', 'onetone'),12),
	   ...
	   $options[] =   	 array(
		...
		switch( $i ){
			...
			case "9": //Courseware
                            ...
                            $options[] = array(
						  'name' => sprintf(__('Moodle Image', 'onetone'),$t+1),
						  'id'   => "moodle_img",
						  'std'  => $avatar[$t],
						  'type' => 'upload',
						  'class'=>'content-model-0 section-item accordion-group-section-'.$i,
						  'desc'=>_('Set image of the moodle'));
						
                            $options[] = array(
						  'name' => sprintf(__('Link', 'onetone'),$t+1),
						  'id'   => "moodle_link",
						  'std'  => '',
						  'type' => 'text',
						  'class'=>'content-model-0 section-item accordion-group-section-'.$i
                            ...
                            $options[] = array(
						  'name' => sprintf(__('Name', 'onetone'),$t+1),
						  'id'   => "moodle_name",
						  'std'  => '',
						  'type' => 'text',
						  'class'=>'content-model-0 section-item accordion-group-section-'.$i
                            ...
                            $options[] = array(
						  'name' => sprintf(__('Description', 'onetone'),$t+1),
						  'id'   => "moodle_desc",
						  'std'  => '',
						  'type' => 'textarea',
						  'class'=>'content-model-0 section-item accordion-group-section-'.$i
                             ...
                             $options[] = array(
						  'name' => sprintf(__('ACU Image logo', 'onetone'),$t+1),
						  'id'   => "acu_img",
						  'std'  => $avatar[$t],
						  'type' => 'upload',
						  'class'=>'content-model-0 section-item accordion-group-section-'.$i
...
$options[] = array('name' => '','id' => 'sidebar_404_group_','type' => 'end_group','class'=>'');	
	  ...
	  $options[] = array('name' => '','id' => 'wrapper_start','type' => 'wrapper_start','class'=>'');
	    ...
	    $options[] = array('name' => '','id' => 'slide_5_group','type' => 'end_group','class'=>'');
            //slider 
            $options[] = array('name' => '','id' => 'slide_6_group','type' => 'start_group','class'=>'');
		
		$options[] =   	 array(
						  'id'          => 'slide_titled_6',
						  'name'       => __('Slide 6', 'onetone').' <span id="accordion-group-slide-6" class="fa fa-plus"></span>',
						  'desc'        => '',
						  'std'         => '',
						  'type'        => 'textblock-titled',
						  'rows'        => '',
		...
		$options[] = array(
						   'name' => __('Image', 'onetone'),
						   'id' => 'onetone_slide_image_6',
						   'type' => 'upload',
						   'std'=>ONETONE_THEME_BASE_URL.'/images/banner-2.jpg',
						   'class'=>'slide-item accordion-group-slide-6'
						   );
		
		$options[] = array(
						   'name' => __('Text', 'onetone'),
						   'id' => 'onetone_slide_text_6',
						   'type' => 'editor',
						   'std'=>'<h1>Fluid, flexible, fantastically minimal.</h1><p>Use any HTML in your slides, extend with CSS. You have full control.</p><a class="btn" href="#download">Download</a>',
						   'class'=>'slide-item accordion-group-slide-6'
						   );
		...
		$options[] = array('name' => '','id' => 'wrapper_end','type' => 'wrapper_end','class'=>'');
		$options[] = array('name' => '','id' => 'slide_6_group_','type' => 'end_group','class'=>'');
